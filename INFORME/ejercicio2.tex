...
\begin{figure}[H]
	\begin{center}
	\begin{KarnaughTP3}
	\contingut{0,0,1,0,X,X,X,0,1,1,1,0,X,X,X,0}
	\implicant{2}{6}{red}
	\implicant{8}{8}{blue}
	\end{KarnaughTP3}
	\end{center}
...
\begin{align*}
	Q_{0_{t+1}} &= W\overline{Q_{2}} \overline{Q_{1}} \overline{Q_{0}} + \overline{W}Q_{1}\overline{Q_{0}} \\
	Q_{1_{t+1}} &= WQ_{2} + W\overline{Q_{1}}Q_{0} + \overline{W}Q_{1}\overline{Q_{0}} \\
	Q_{2_{t+1}} &= WQ_{1}Q_{0} \\
	Z &= Q_{2} \\
\end{align*}
